//add uva424, uva465, uva495, uva485, uva10183, uva10334, uva10523, uva10579
//mlt uva465, uva623, uva748, uva10220, uva10523
//sub 11448
#include <iostream>
#include <algorithm>
#include <queue>
...
{     
  while(true){
    ...
    BigInteger cnt("1");
    BigInteger tmp("1");
    int lim = atoi( n.c_str() );
    REP(i, lim){
      tmp = tmp * A;
      BigInteger no = tmp * cnt;
      sum = sum + no;
      cnt = cnt + one;
    }
